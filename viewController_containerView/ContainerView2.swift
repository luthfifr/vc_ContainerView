...
class ContainerView2: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.scrollView2.addSubview(gambar1)
        self.scrollView2.addSubview(gambar2)
        self.scrollView2.addSubview(gambar3)
        self.scrollView2.addSubview(gambar4)
        self.scrollView2.addSubview(gambar5)
        self.scrollView2.addSubview(gambar6)
        self.scrollView2.addSubview(gambar7)
        self.scrollView2.addSubview(gambar8)
        self.scrollView2.addSubview(gambar9)
        self.scrollView2.addSubview(gambar10)
        
        self.scrollView2.contentSize = CGSize(width: gambar10.frame.size.width+gambar10.frame.origin.x+CGFloat(ukuranXgambar), height: self.scrollView2.frame.size.height)
    }
