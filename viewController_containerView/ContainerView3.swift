...
class ContainerView3: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.scrollView3.addSubview(gambar1)
        self.scrollView3.addSubview(gambar2)
        self.scrollView3.addSubview(gambar3)
        self.scrollView3.addSubview(gambar4)
        self.scrollView3.addSubview(gambar5)
        self.scrollView3.addSubview(gambar6)
        self.scrollView3.addSubview(gambar7)
        self.scrollView3.addSubview(gambar8)
        self.scrollView3.addSubview(gambar9)
        self.scrollView3.addSubview(gambar10)
        
        self.scrollView3.contentSize = CGSize(width: gambar10.frame.size.width+gambar10.frame.origin.x+CGFloat(ukuranXgambar), height: self.scrollView3.frame.size.height)
    }
